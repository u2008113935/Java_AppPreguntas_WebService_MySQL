...
public class MainActivity extends AppCompatActivity {
    ...
    public void DisplayNextQuestions() {
        ...
        int selectOption = binding.radioGroup.getCheckedRadioButtonId();
        if (selectOption != -1) {
            RadioButton radioButton = findViewById(selectOption);
            ...
            if ((questionList.size() - i) > 0) {
                ...
                //Ckeck if the chosen option is correct
            ...
            Toast.makeText(
                    this, "Necesitas hacer seleccionnes",
